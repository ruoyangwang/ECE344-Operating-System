...
struct lock {
	...
	//volatile int bowl; 	//get a variable to indicate hold status....  BY LEO
	//volatile int who;		//NOT occupied =0, taken by cat =1, taken by mouse =2;
	volatile struct thread  *own;	//indicating the owner of curthread
	//struct queue *q;
};
